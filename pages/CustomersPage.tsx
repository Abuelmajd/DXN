                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className="bg-indigo-100 dark:bg-slate-700 p-2 rounded-full">
                                        <UserCircleIcon />
                                    </div>
                                    <h2 className="text-xl font-bold text-slate-900 dark:text-white truncate group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{customer.name}</h2>
                                </div>
                                ...
                                <div className="flex flex-col space-y-3 pt-4 border-t border-slate-200 dark:border-slate-700 mt-auto">
                                    ...
                                    {customer.phone && (
                                        <a href={`tel:${customer.phone}`} onClick={e => e.stopPropagation()} className="flex items-center gap-3 text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors font-medium">
                                            <PhoneIcon />
